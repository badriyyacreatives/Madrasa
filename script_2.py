# Create complete parents portal
print("🎯 Creating parents_final.html...")

parents_final = '''<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                ${student.password ? 
                                    '<p class="text-xs text-green-600">🔐 Password protected</p>' : 
                                    '<p class="text-xs text-orange-600">⚠️ No password set</p>'
                                }
                            </div>
                        </div>
                        <svg class="w-6 h-6 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                ${time ? `<p class="text-sm text-gray-600 mt-1">⏰ Marked at ${time}</p>` : ''}
                            </div>
                        </div>
...
# Save parents file
with open('parents_final.html', 'w', encoding='utf-8') as f:
    f.write(parents_final)

print("✅ Created parents_final.html")
print(f"📏 File size: {len(parents_final) / 1024:.1f} KB")
print("🎯 Complete parents portal with all features!")